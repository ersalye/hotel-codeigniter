        ...
        <div class="card-block">
            <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <select id="transporter_id" name="transporter_id" class="form-control">
                        <option value="">Choose Delivery People</option>
						 ...
						 <?php foreach($people as $p){ ?>
							   <option value="<?php echo $p['id'];?>" <?=$p['id'] == $pages['transporter_id'] ? ' selected="selected"' : '';?>><?php echo $p['name'];?></option>
                               <?php  } 
                ...
                <div class="form-group col-xs-12 mb-2">
                    ...
                    <input type="text" id="title"  class="form-control "  name="title" value="<?php if (!empty($pages)){echo $pages['title']; }?>"  required  />
                                        </div>
                <div class="form-group col-xs-12 mb-2">
                    <label for="name">Notice</label>
                    <textarea id="notice"  class="form-control "  name="notice"  required ><?php if (!empty($pages)){echo $pages['notice']; }?></textarea>

                                        </div>
                <div class="form-group col-xs-12 mb-2">
                    <label for="name">Extra Note</label>
                    <input type="text" id="note"  class="form-control "  name="note" value="<?php if (!empty($pages)){echo $pages['note']; }?>" />
                                        </div>
                <div class="col-xs-12 mb-2">
                    <a href="<?php echo base_url(); ?>Admin/Notice" class="btn btn-warning mr-1">
