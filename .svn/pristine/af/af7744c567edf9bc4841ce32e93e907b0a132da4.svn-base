                    ...
                    <ul class="nav navbar-nav float-xs-right">
                        <li class="dropdown dropdown-notification nav-item">
                            <a href="#"  class="nav-link nav-link-label">
                                ...
                                <span class="tag tag-pill tag-default tag-danger tag-default tag-up" id="tot_incom_order">5</span>
                            </a>
      ...
      <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                ...
                <li class=" nav-item"><a href="<?php echo base_url(); ?>Shop/Profile"><i class="fa fa-cutlery"></i><span data-i18n="" class="menu-title">Restaurant</span></a>
                    
                </li>
                                <li class=" nav-item"><a href="#"><i class="fa fa-shopping-bag"></i><span data-i18n="" class="menu-title">Addons</span></a>
                    <ul class="menu-content">
                        <li><a href="<?php echo base_url(); ?>Shop/Addons" class="menu-item">Addons List</a></li>
                        <li><a href="<?php echo base_url(); ?>Shop/AddAddons" class="menu-item">Add Addons</a></li>
                    </ul>
                </li>
                                 <li class=" nav-item"><a href="#"><i class="fa fa-shopping-bag"></i><span data-i18n="" class="menu-title">Category</span></a>
                    <ul class="menu-content">
                        <li><a href="<?php echo base_url(); ?>Shop/Category" class="menu-item">Category List</a></li>
                        <li><a href="<?php echo base_url(); ?>Shop/Addcategory" class="menu-item">Add Category</a></li>
                    </ul>
                </li>
                 <li class=" nav-item"><a href="#"><i class="fa fa-shopping-bag"></i><span data-i18n="" class="menu-title">Product</span></a>
                    <ul class="menu-content">
                        <li><a href="<?php echo base_url(); ?>Shop/Products" class="menu-item">Product List</a></li>
                        <li><a href="<?php echo base_url(); ?>Shop/AddProducts" class="menu-item">Add Product</a></li>
                    </ul>
                </li>
                <li class=" nav-item">
