    ...
    <div class="card-body collapse in">
        <div class="card-block card-dashboard table-responsive">
            <table class="table table-striped table-bordered file-export">
                ...
                <tbody><?php $i= 1; foreach($pages as $p){ ?>
										<tr>
										     <td><?php echo $i; ?></td>
                                             <td><?php $idd = $p['shop_id'];
											$CI =& get_instance();
											$CI->Shopname($idd) ;
											 ?></td>
                                        <td>
                      <img src="<?php echo base_url(); ?>uploads/images/<?php echo $p['banner']; ?>" width="50px" height="50">
                        </td>
                        <td><?php echo $p['status']; ?></td>
                        <td>
						<a href="EditRBanner/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-success"><i class="fa fa-pencil-square-o"></i></a>
                                <a href="BannerDelete/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-danger">Remove</a></td>
                    </tr>
