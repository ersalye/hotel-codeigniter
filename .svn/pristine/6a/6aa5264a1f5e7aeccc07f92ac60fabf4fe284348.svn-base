                                 ...
                                 <div class="row everyday">
                                    <div class="col-xs-4">
                                       <div class="form-group">
                                          ...
                                          <input type="checkbox" class="chk"  checked   name="day[ALL]" value="ALL" >
                                       </div>
                                    </div>
                                    <div class="col-xs-4">
                                       <div class="form-group">
                                          ...
                                          <div class="input-group clockpicker">
                                             <input type="text" class="form-control" name="m_hours_opening" value="<?php if (!empty($people)){echo $people['m_resturant_opens']; }?>" >
                                    ...
                                    <div class="col-xs-4">
                                       <div class="form-group">
                                          ...
                                          <div class="input-group clockpicker">
                                             <input type="text" class="form-control" name="m_hours_closing" value="<?php if (!empty($people)){echo $people['m_resturant_close']; }?>" >
                                             <span class="input-group-addon">
                                             <i class="fa fa-clock-o"></i>
                                             </span>
                                          </div>
                                    ...
                                    <div class="col-xs-4">
                                       <div>
                                          <div class="input-group clockpicker">
                                             <input type="text" class="form-control" name="e_hours_opening" value="<?php if (!empty($people)){echo $people['e_resturant_opens']; }?>" >
                                             <span class="input-group-addon">
                                             <i class="fa fa-clock-o"></i>
                                             </span>
                                          </div>
                                    ...
                                    <div class="col-xs-4">
                                       <div>
                                          <div class="input-group clockpicker">
                                             <input type="text" class="form-control" name="e_hours_closing" value="<?php if (!empty($people)){echo $people['e_resturant_close']; }?>" >
                                             <span class="input-group-addon">
                                             <i class="fa fa-clock-o"></i>
                                             </span>
                                          </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" value="0" <?php if (!empty($people)){?> <?=$people['pure_veg'] == '0' ? ' checked="checked"' : ''; }?>  name="pure_veg">No
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" value="1"<?php if (!empty($people)){?> <?=$people['pure_veg'] == '1' ? ' checked="checked"' : '';?> <?php }?>name="pure_veg">Yes
                                    </label>
