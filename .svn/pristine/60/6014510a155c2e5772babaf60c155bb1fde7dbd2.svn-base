<?php $this->view('web/header') ?>
                                    ...
                                    <div class="col-sm-12">
                                       <div class="row new-sec">
                                          <div class="col-sm-12 col-md-12 col-lg-8">
                                             ...
                                             <div class="m-t-10">
                                                <button onclick="location.href='checkout.html'" type="button" class="btn theme-btn btn-sm">GET HELP</button>
                                       ...
                                       <div class="panel panel-default">
                                          <div class="panel-heading" role="tab" id="headingOne">
                                             <h4 class="panel-title">
                                                ...
                                                Terms of Use <i class="fa fa-angle-down pull-right" aria-hidden="true"></i>
                                                </a>
                                             </h4>
                                          </div>
                                       ...
                                       <div class="panel panel-default">
                                          <div class="panel-heading" role="tab" id="headingTwo">
                                             <h4 class="panel-title">
                                                ...
                                                Privacy Policy <i class="fa fa-angle-down pull-right" aria-hidden="true"></i>
                                                </a>
                                             </h4>
                                          </div>
                                       ...
                                       <div class="panel panel-default">
                                          <div class="panel-heading" role="tab" id="headingThree">
                                             <h4 class="panel-title">
                                                ...
                                                Cancellations and Refunds <i class="fa fa-angle-down pull-right" aria-hidden="true"></i>
                                                </a>
                                             </h4>
                                          </div>
                                       ...
                                       <div class="panel panel-default">
                                          <div class="panel-heading" role="tab" id="headingfour">
                                             <h4 class="panel-title">
                                                ...
                                                Terms of Use for Swiggy ON-TIME / Assured <i class="fa fa-angle-down pull-right" aria-hidden="true"></i>
                                                </a>
                                             </h4>
                                          </div>
      ...
      <script src="<?php echo base_url(); ?>web-assets/js/jquery.nice-number.js"></script>
