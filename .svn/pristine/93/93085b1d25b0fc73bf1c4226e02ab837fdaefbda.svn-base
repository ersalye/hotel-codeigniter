...
<div class="app-content content container-fluid">
    ...
    <div class="card-header">
        <h3 class="card-title"><?php if (!empty($people)){ echo "Edit"; }else{?>Add <?php } ?> User </h3>
    </div>
    <div class="card-body collapse in">
        <div class="card-block">
            <form class="form-horizontal" role="form" method="POST" id="user_form"  action="" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="EfpS9wfDaFRvZ5HXrsXG43sCN0Ui2NTTXTmJ8VF2">
                <div class="form-group col-xs-12 mb-2">
                     <input id="name" type="text" class="form-control" name="name" value="<?php if (!empty($people)){echo $people['first_name']; }?>" required placeholder="Name" autofocus>
...
<button type="button" id="dropify-clearr" class="dropify-clear">Remove</button><div class="dropify-preview" style="display: block;"><span class="dropify-render"><img src="<?php echo base_url(); ?>uploads/images/<?php if (!empty($people)){echo $people['profile_image']; }?>"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-filename"><span class="file-icon"></span> <span class="dropify-filename-inner"><?php if (!empty($people)){echo $people['profile_image']; }?></span></p><p class="dropify-infos-message">Drag and drop or click to replace</p></div></div></div></div>
                ...
                <div class="form-group col-xs-12 mb-2 contact-repeater">
                    <div data-repeater-list="repeater-group">
                        ...
                        <div class="col-md-2 no-pad">
                                <!-- <input type="tel" id="country_code" class="form-control country_div" value="" name="country_code" > -->
                                <input id="country_code" class="form-control country_div"  name="country_code" autocomplete="off" style="padding: 10px;" type="tel" value="<?php if (!empty($people)){echo $people['country_code']; }?>" required placeholder="Country Code">
                                </div>
                                
                                 <div class="col-md-10  no-pad">
                                <input id="phone1" type="text" class="form-control phone-number phone_fileds" name="phone_number" value="<?php if (!empty($people)){echo $people['phone']; }?>" placeholder="Phone Number" required autofocus>
                ...
                <div class="col-xs-12 mb-2">
                    <a href="<?php echo base_url(); ?>admin/Users" class="btn btn-warning mr-1">
