            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        ...
                        <li><a href="AddPeople" class="btn btn-primary add-btn btn-darken-3">Add Delivery People</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card-block card-dashboard table-responsive">
                    <table class="table table-striped table-bordered file-export">
                     ...
                     <img src="<?php echo base_url(); ?>uploads/images/<?php echo $p['profile_image']; ?>" width="50px" height="50">
                                   ...
                                   <a href="EditPeople/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-success"><i class="fa fa-pencil-square-o"></i></a>
                                       
                                        <a href="DPeopleDelete/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-danger"><i class="fa fa-trash-o"></i></a>
