            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        ...
                        <li><a href="AddManager" class="btn btn-primary add-btn btn-darken-3">Add Dispute Manager</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card-block card-dashboard table-responsive">
                    <table class="table table-striped table-bordered file-export">
                     ...
                     <img src="<?php echo base_url(); ?>uploads/images/<?php echo $p['profile_image']; ?>" width="50px" height="50">
                                    ...
                                    <td>
								 <a href="EditManager/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-success"><i class="fa fa-pencil-square-o"></i></a>
                                <a href="DManagerDelete/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-danger"><i class="fa fa-trash-o"></i></a>
