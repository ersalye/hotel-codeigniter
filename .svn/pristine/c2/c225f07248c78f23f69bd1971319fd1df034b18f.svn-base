                            ...
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li><a href="#" class="btn btn-primary add-btn btn-darken-3">Add Resturant</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body collapse in">
							 ...
							 <?php $i= 1; foreach($orders as $o){ ?>
								...
								?></td>
                                                    ...
                                                    <td> <a href="<?php echo base_url('Admin/Sales_info_details/').$o['o_id']; ?>" class="btn btn-primary btn-darken-3 tab-order">View Details</a></td>
