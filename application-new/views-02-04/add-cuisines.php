                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control" name="name" value="<?php if (!empty($pages)){echo $pages['name']; }?>" required autofocus>
						...
						<div class="col-md-4 col-md-offset-4">
                           <a href="<?php echo base_url(); ?>Admin/Cuisines" class="btn btn-warning mr-1">
