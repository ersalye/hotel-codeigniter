                            ...
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li><a href="AddPromocode" class="btn btn-primary add-btn btn-darken-3">Add Promocode</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="card-block card-dashboard table-responsive">
                                    <table class="table table-striped table-bordered file-export">
										...
										<tr>
                                                    ...
                                                    <td><?php echo $p['promocode_type']; ?></td>
                                                    <td><?php echo $p['discount']; ?></td>
                                                    <td><?php echo $p['expiration']; ?></td>
                                                    <td><?php echo $p['status']; ?></td>
                                                   
                                                    <td>
                                                    <a href="EditPcode/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-success"><i class="fa fa-pencil-square-o"></i></a>
                                <a href="PromocodesDelete/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-danger"><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr><?php $i++; } ?>
                                                                                    </tbody>
                                    </table>
