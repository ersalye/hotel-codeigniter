        ...
        <div class="card-block">
            <form class="form-horizontal" id="transporter_form" role="form" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group col-xs-12 col-md-6 mb-2">
                     <input id="name" type="text" class="form-control" name="name" value="" required placeholder="Name" autofocus>
                 ...
                 <div class="form-group mb-2">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="pac-input" type="text" class="form-control" name="address"  required placeholder="Address" value=""  />
