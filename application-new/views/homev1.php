...
<html class="no-js" lang="zxx">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo base_url(); ?>assets/material-design-iconic-font/css/material-design-iconic-font.min.css">
                  ...
                  <div class="row">
                     <div class="col-lg-2 col-sm-4 col-md-6 order-1 order-lg-1">
                        <div class="logo">
                           ...
                           <img src="<?php echo base_url(); ?>assets/images/logo.png" alt="logo images">
                           </a>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-2 col-sm-4 col-md-4 order-2 order-lg-3">
                        <div class="header__right d-flex justify-content-end">
                           <div class="log__in">
                              <a class="accountbox-trigger" href="#">Sign In / Sign Up </a>
                           </div>
                  ...
                  <div class="row mt--30">
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="service">
                           <div class="service__title">
                              <div class="ser__icon">
                                 <img src="<?php echo base_url(); ?>assets/images/1.png" alt="icon image">
                              </div>
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="service">
                           <div class="service__title">
                              <div class="ser__icon">
                                 <img src="<?php echo base_url(); ?>assets/images/2.png" alt="icon image">
                              </div>
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="service">
                           <div class="service__title">
                              <div class="ser__icon">
                                 <img src="<?php echo base_url(); ?>assets/images/3.png" alt="icon image">
                              </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="food__item foo">
                           <div class="food__thumb">
                              ...
                              <img src="<?php echo base_url(); ?>assets/images/category-1.jpg" alt="product images">
                              </a>
                           </div>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="food__item foo">
                           <div class="food__thumb">
                              <a href="menu-details.html">
                              <img src="<?php echo base_url(); ?>assets/images/category-2.jpg" alt="product images">
                              </a>
                           </div>
                           <div class="food__title">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="food__item foo">
                           <div class="food__thumb">
                              <a href="menu-details.html">
                              <img src="<?php echo base_url(); ?>assets/images/category-3.jpg" alt="product images">
                              </a>
                           </div>
                           <div class="food__title">
                                    ...
                                    <div class="single__tab__content">
                                       ...
                                       <div class="food__menu">
                                          <div class="food__menu__thumb">
                                             <a href="menu-details.html">
                                             <img src="<?php echo base_url(); ?>assets/images/s1.jpg" alt="product images">
                                             </a>
                                          </div>
                                       ...
                                       <div class="food__menu">
                                          <div class="food__menu__thumb">
                                             <a href="menu-details.html">
                                             <img src="<?php echo base_url(); ?>assets/images/s2.jpg" alt="product images">
                                             </a>
                                          </div>
                                          <div class="food__menu__details">
                                             <div class="fd__menu__title__prize">
               ...
               <div class="row mt--80">
                  <div class="col-lg-12 poss--relative">
                     <div class="app__download__container">
                        <div class="app__download__inner inline__image__css--1" style="background-image: url(<?php echo base_url(); ?>assets/images/bg.png);">
                           <h2>Storkks now in your hand</h2>
                           <h6>Download! to get this app Faster way to order food</h6>
                        </div>
                        <ul class="dwn__app__list">
                           <li class="wow lightSpeedIn" data-wow-delay="0.2s"><a href="#"><img src="<?php echo base_url(); ?>assets/images/app2.png" alt="app images"></a></li>
                           <li class="wow lightSpeedIn" data-wow-delay="0.3s"><a href="#"><img src="<?php echo base_url(); ?>assets/images/playstore.png" alt="app images"></a></li>
                        </ul>
                     </div>
                     <div class="app__phone wow fadeInLeft" data-wow-delay="0.2s">
                        <img src="<?php echo base_url(); ?>assets/images/app.png" alt="app images">
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="testimonial__activation--1 text-center bg--white owl-carousel owl-theme clearfix">
                        ...
                        <div class="testimonial">
                           <div class="testimonial__thumb">
                              <img src="<?php echo base_url(); ?>assets/images/test-1.png" alt="testimonial images">
                           </div>
               ...
               <div class="row mt--40">
                  ...
                  <div class="col-md-6 col-lg-4 col-sm-12 foo">
                     <div class="blog">
                        <div class="blog__thumb">
                           ...
                           <img src="<?php echo base_url(); ?>assets/images/blog-1.jpg" alt="blog images">
                           </a>
                        </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-sm-12 foo">
                     <div class="blog">
                        <div class="blog__thumb">
                           <a href="blog-details.html">
                           <img src="<?php echo base_url(); ?>assets/images/blog-2.jpg" alt="blog images">
                           </a>
                        </div>
                        <div class="blog__details">
                  ...
                  <div class="col-md-6 col-lg-4 col-sm-12 foo">
                     <div class="blog">
                        <div class="blog__thumb">
                           <a href="blog-details.html">
                           <img src="<?php echo base_url(); ?>assets/images/blog-3.jpg" alt="blog images">
                           </a>
                        </div>
                        <div class="blog__details">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-6 col-lg-3 col-sm-12">
                        <div class="footer">
                           <h2 class="ftr__title">About Storkks</h2>
                              ...
                              <div class="ftr__details">
                                 ...
                                 <div class="ftr__address__inner">
                                    ...
                                    <div class="ftr__address">
                                       ...
                                       <div class="frt__address__details">
                                          <p><a href="#">+60 345 678 102</a></p>
                                          <p><a href="#">+60 315 672 103</a></p>
                                       </div>
                                    </div>
                                    <div class="ftr__address">
                                       <div class="ftr__address__icon">
                        ...
                        <div class="footer gallery">
                           ...
                           <div class="footer__inner">
                              <ul class="sm__gallery__list">
                                 <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/f1.jpg" alt="gallery images"></a></li>
                                 <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/f2.jpg" alt="gallery images"></a></li>
                                 <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/f3.jpg" alt="gallery images"></a></li>
                                 <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/f1.jpg" alt="gallery images"></a></li>
                                 <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/f2.jpg" alt="gallery images"></a></li>
                                 <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/f3.jpg" alt="gallery images"></a></li>
                              </ul>
                              ...
                              <div class="lst__post__list">
                                 <div class="single__sm__post">
                                    <div class="sin__post__thumb">
                                       <a href="blog-details,html">
                                       <img src="<?php echo base_url(); ?>assets/images/b1.jpg" alt="blog images">
                                       </a>
                                    </div>
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="copyright__inner">
                           <div class="cpy__right--left">
                              <p>@All Right Reserved.<a href="#">Storkks</a></p>
                           </div>
                           <div class="cpy__right--right">
                              <a href="#">
                              <img src="<?php echo base_url(); ?>assets/images/card.png" alt="payment images">
                              </a>
                           </div>
                        </div>
                     </div>
         ...
         <div class="accountbox-wrapper">
            <div class="accountbox text-left">
               <ul class="nav accountbox__filters" id="myTab" role="tablist">
                  <li>
                     <a class="active" id="log-tab" data-toggle="tab" href="#log" role="tab" aria-controls="log" aria-selected="true">Sign In</a>
                  </li>
                  <li>
                     <a id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Sign Up</a>
                  </li>
               </ul>
               <div class="accountbox__inner tab-content" id="myTabContent">
                  ...
                  <div class="accountbox__register tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                     <form class="form" action="#">
                        <div class="single-input">
                           <input class="cr-round--lg" id="name" type="text" placeholder="User name">
                        </div>
                        <div class="single-input">
                           <input class="cr-round--lg" id="email" type="email" placeholder="Email address">
                        </div>
                        <div class="single-input">
                           <input class="cr-round--lg" id="password" type="password" placeholder="Password">
                        </div>
                        <div class="single-input">
                           <input class="cr-round--lg" id="cpassword" type="password" placeholder="Confirm password">
                        </div>
                        <div class="single-input">
                           <button id="register" type="button" class="food__btn"><span>Sign Up</span></button>
                        </div>
                     </form>
                  </div>
                  ...
                  <div class="cartbox__items">
                     ...
                     <div class="cartbox__item">
                        <div class="cartbox__item__thumb">
                           ...
                           <img src="<?php echo base_url(); ?>assets/images/s1.jpg" alt="small thumbnail">
                           </a>
                        </div>
                     ...
                     <div class="cartbox__item">
                        <div class="cartbox__item__thumb">
                           <a href="product-details.html">
                           <img src="<?php echo base_url(); ?>assets/images/s2.jpg" alt="small thumbnail">
                           </a>
                        </div>
                        <div class="cartbox__item__content">
...
if (data == 'Thanks for register will get back to you soon') {
$("form")[0].reset();
}
alert(data);
$("form")[0].reset();
