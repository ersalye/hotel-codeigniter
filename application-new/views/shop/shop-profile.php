          ...
          <form role="form" method="POST" action="" enctype="multipart/form-data" onkeypress="return disableEnterKey(event);">
               ...
               <input type="hidden" id="longitude" name="longitude" value="80.2757063" readonly required>
                <h4 class="m-t-0 header-title">
                    <b>Edit Shop</b>
					<?php $ip  = !empty($_SERVER['HTTP_X_FORWARDED_FOR']) ? $_SERVER['HTTP_X_FORWARDED_FOR'] : $_SERVER['REMOTE_ADDR'];
						...
						<div class="row everyday">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group clockpicker">
                                        <input type="text" class="form-control" name="hours_opening[ALL]"                                         value="<?php if (!empty($profile)){echo $profile['resturant_opens']; }?>" 
                                         required>
                            ...
                            <div class="col-xs-4">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group clockpicker">
              <input type="text" class="form-control" name="hours_closing[ALL]" value="<?php if (!empty($profile)){echo $profile['resturant_close']; }?>"timings                                         required>
                                        <span class="input-group-addon">
                                            <i class="fa fa-clock-o"></i>
                                        </span>
                                    </div>
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group clockpicker">
                                        ...
                                        value="<?php if (!empty($profile)){echo $profile['resturant_opens']; }?>" 
                                         required>
                                        <span class="input-group-addon">
                                            <i class="fa fa-clock-o"></i>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" value="no" <?php if ($profile['pure_veg']== 'no'){ ?> checked <?php } ?> name="pure_veg">No
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" value="yes"  name="pure_veg" <?php if ($profile['pure_veg']== 'yes'){ ?> checked <?php } ?> >Yes
                                    </label>
