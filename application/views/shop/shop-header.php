                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url('Shop'); ?>" class="navbar-brand">
                            <img alt="stack admin logo" src="<?php echo base_url(); ?>web-assets/images/storkks_logo.png" width="130" class="brand-logo">
                    ...
                    <ul class="nav navbar-nav float-xs-right">
                        <li class="dropdown dropdown-notification nav-item">
                            <a href="<?php echo base_url('Shop'); ?>"  class="nav-link nav-link-label">
                                ...
                                <span class="tag tag-pill tag-default tag-danger tag-default tag-up" id="tot_incom_order"></span>
                            </a>
