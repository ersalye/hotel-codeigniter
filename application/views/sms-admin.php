                     ...
                     <div class="card-block">
                        <form class="form-horizontal" role="form" method="POST" action="https://foodie.deliveryventure.com/admin/banner" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                            <label for="name">Twilio SMS Account ID <span class="req">*</span></label>

                            <input type="text" class="form-control" name="name" value="" required="" autofocus="">

                           </div>
                           <div class="form-group">
                            <label for="name">Twilio SMS Account Token <span class="req">*</span></label>

                            <input  type="text" class="form-control" name="name" value="" required="" autofocus="">

                           </div>
						   <div class="form-group">
                            <label for="name">Twilio SMS Sender Number <span class="req">*</span></label>
