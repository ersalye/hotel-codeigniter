            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        ...
                        <li><a href="AddCuisines" class="btn btn-primary add-btn btn-darken-3">Add Cuisine</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card-block card-dashboard table-responsive">
                    <table class="table table-striped table-bordered file-export">
						...
						<?php 
                                    ...
                                    <td>
								<a href="EditCuisines/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-success"><i class="fa fa-pencil-square-o"></i></a>
                                <a href="CuisinesDelete/<?php echo $p['id']; ?>" class="table-btn btn btn-icon btn-danger"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr><?php $i++; } ?>
