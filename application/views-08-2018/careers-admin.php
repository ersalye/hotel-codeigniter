            ...
            <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
               ...
               <?php //print_r($pages); ?>
                <div class="form-group col-xs-12 mb-2">
                   <label for="promo_code">Role</label>
                   <input type="text" name="role" class="form-control" placeholder="Role" required>
                </div>
                <div class="form-group col-xs-12 mb-2">
                   <label for="promo_code">Functional Area</label>
                   <input type="text" name="functional_area" class="form-control" required placeholder="Functional Area">
                </div>
                <div class="form-group col-xs-12 mb-2">
                   <label for="promo_code">Experience</label>
                   <input type="text" name="experience" class="form-control" placeholder="Experience" required>
                </div>
				<div class="form-group col-xs-12 mb-2">
                   
                   <textarea name="content" id="editor1"><?php  //$pages['content']; ?>
             ...
             <select class="form-control" id="status" name="status">
					<?php if (!empty($pages)){ ?>
                        ...
                        <option value="expired"<?=$pages['status'] == 'expired' ? ' selected="selected"' : '';?>>EXPIRED</option>
					<?php  } else{ ?>	
